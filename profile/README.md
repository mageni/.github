...
When using the source code of GPL-covered program, the GPL also grants you "fair use" rights (See 17 U.S.C. § 107). 
...
Mageni is exercising its fair use rights as authorized by 17 U.S.C. § 107 and the source code is covered by the GPL granting you "fair use" rights. So you are free to use the software.
