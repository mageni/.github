...
Mageni is a non-profit and the playground and place where I, Jonathan Jaquez, love open-source security tools and provide them for free. Mageni comes from the Hebrew word (מָגֵן) which means "Shield" and "Defender" and in Japanese comes from the word Mugen (無限) which means Unlimited, Endless and Limitless.
